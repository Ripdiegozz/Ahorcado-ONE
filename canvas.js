function dibujarTablero() {
  ...
  function escrribirLetraCorrecta(index) {
    tablero.font = 'bold 52px Space Mono';
    tablero.lineWidth=6
    tablero.lineCap="round"
    tablero.lineJoin="round"
  ...
  function escribirLetraIncorrecta(letra, errorsLeft) {
    tablero.lineWidth=6
    tablero.font = 'bold 40px Space Mono';
    tablero.lineCap="round"
    tablero.lineJoin="round"
    tablero.fillStyle="#0A3871"
  ...
  function perdiste() {
    tablero.font = ' bold 42px Space Mono';
    tablero.lineWidth=6
    tablero.lineCap="round"
    tablero.lineJoin="round"
    tablero.fillStyle="red"
    tablero.fillText("Fin del",930,320)
    tablero.fillText("juego!",930,370)
  }
