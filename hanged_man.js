...
var palabras = ['DESARROLLO', 'PICANTE', 'MURCIELAGO', 'PLANTAS', 'AVES', 'NUBE', 'CARRO', 'IMPRESORA', 'AMONGUS', 'ROUTER', 'LAPTOP', 'COLOMBIA'  ];
...
function iniciarJuego() {
  ...
  document.onkeydown = (e) => {
    ...
    if (letrasIncorrectas.length <= numeroDeErrores) {
      ...
      alert('Alcanzaste el límite de letras incorrectas')
    }
